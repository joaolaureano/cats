...
var BackButtonComponent = /** @class */ (function () {
    ...
    BackButtonComponent.prototype.getBack = function (e) {
        e.preventDefault();
        window.history.back();
    };
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.getHttpImage = function (code) {
        return this.http.get(this.httpEndPoint + code);
    };
    HttpService.prototype.getCat = function () {
...
var CatsFullScreenComponent = /** @class */ (function () {
    function CatsFullScreenComponent(http) {
        this.http = http;
        this.groupCat = [];
    }
    CatsFullScreenComponent.prototype.ngOnInit = function () {
        this.generateCat();
    };
    CatsFullScreenComponent.prototype.generateCat = function () {
        var _this = this;
        for (var i = 0; i < 50; i++)
            this.http.getCat().subscribe(function (res) {
                _this.groupCat.push(res["file"]);
            });
    };
    CatsFullScreenComponent.ctorParameters = function () { return [
    ...
    return CatsFullScreenComponent;
}());
...
var HttpGeneratorComponent = /** @class */ (function () {
    function HttpGeneratorComponent(http) {
        this.http = http;
        this.httpImage = "../../assets/FUNNYCAT2.jpg";
    }
    HttpGeneratorComponent.prototype.ngOnInit = function () { };
    HttpGeneratorComponent.prototype.generateFunnyImage = function () {
        this.httpImage = "https://http.cat/" + this.httpCode;
    };
    HttpGeneratorComponent.ctorParameters = function () { return [
        { type: _http_service__WEBPACK_IMPORTED_MODULE_2__["HttpService"] }
    ]; };
...
var RandomImagesComponent = /** @class */ (function () {
    function RandomImagesComponent(spinnerHandler, serviceImage) {
    ...
    RandomImagesComponent.prototype.ngOnInit = function () { };
    RandomImagesComponent.prototype.generateImg = function () {
        var _this = this;
        this.serviceImage.getImage().subscribe(function (res) {
            _this.randomimage = res["file"];
        });
    };
    RandomImagesComponent.prototype.saveImage = function () {
        this.imagesUrl.push(this.randomimage);
    };
    RandomImagesComponent.prototype.deleteImage = function () {
        this.imagesUrl.splice(-1, 1);
    };
    RandomImagesComponent.prototype.showSpinner = function (state) {
        this.spinnerActive = state;
    };
    RandomImagesComponent.ctorParameters = function () { return [
...
var SpinnerHandlerService = /** @class */ (function () {
    function SpinnerHandlerService() {
        var _this = this;
        this.numberOfRequests = 0;
        this.showSpinner = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](false);
        this.handleRequest = function (state) {
            if (state === void 0) { state = "minus"; }
            _this.numberOfRequests =
                state === "plus" ? _this.numberOfRequests + 1 : _this.numberOfRequests - 1;
            _this.showSpinner.next(_this.numberOfRequests > 0);
        };
    }
...
var SpinnerInterceptorService = /** @class */ (function () {
    function SpinnerInterceptorService(spinnerHandler) {
        var _this = this;
        this.spinnerHandler = spinnerHandler;
        this.finalize = function () { return _this.spinnerHandler.handleRequest(); };
    }
    SpinnerInterceptorService.prototype.intercept = function (request, next) {
    ...
    SpinnerInterceptorService.ctorParameters = function () { return [
